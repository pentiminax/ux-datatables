...
/**
 * Strategy for 'notContains' search logic.
 *
 * Performs an inverse substring search using SQL NOT LIKE %value%.
 */
final class NotContainsSearchStrategy implements SearchStrategyInterface
{

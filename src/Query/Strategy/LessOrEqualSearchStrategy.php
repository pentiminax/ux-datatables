...
/**
 * Strategy for 'lessOrEqual' search logic.
 *
 * Performs a less-than-or-equal comparison using SQL <=.
 */
final class LessOrEqualSearchStrategy implements SearchStrategyInterface
{

...
interface ExtensionConfig {
    js: Record<StyleFramework, Loader>
    css: Record<StyleFramework, Loader>
}

const registry: Record<string, ExtensionConfig> = {
    colReorder: {
        js: {
    ...
    columnControl: {
        ...
        css: {
            ...
            bs4: () =>
                import('datatables.net-columncontrol-bs4/css/columnControl.bootstrap4.min.css'),
            bs5: () =>
            ...
            zf: () =>
                import('datatables.net-columncontrol-zf/css/columnControl.foundation.min.css'),
            jqui: () =>
                import('datatables.net-columncontrol-jqui/css/columnControl.jqueryui.min.css'),
            se: () =>
                import('datatables.net-columncontrol-se/css/columnControl.semanticui.min.css'),
        },
    },
    fixedColumns: {
        js: {
        ...
        css: {
            ...
            jqui: () =>
                import('datatables.net-fixedcolumns-jqui/css/fixedColumns.jqueryui.min.css'),

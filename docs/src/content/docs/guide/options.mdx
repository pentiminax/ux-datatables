...
<Aside type="tip">
  All options correspond to [DataTables options](https://datatables.net/reference/option/). Check the official documentation for edge cases and advanced configurations.
</Aside>

...
Position UI components using an array. Each position accepts a `Feature` enum, an array of features, a custom string, or `null`.
...
// Full-width row, null to hide, custom HTML
$dataTable->layout([
    'top'         => '<h2>My Table</h2>',
    'topStart'    => Feature::PAGE_LENGTH,
    'bottomStart' => null,

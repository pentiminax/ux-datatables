...
<Table
  ...
  rows={[
    ...
    ['ColumnType::HTML_NUM', 'Numeric values extracted from HTML content'],
    ['ColumnType::HTML_NUM_FMT', 'Formatted numeric values extracted from HTML content'],
    ['ColumnType::HTML_UTF8', 'HTML content with UTF-8 aware text sorting'],
    ...
    ['ColumnType::STRING_UTF8', 'UTF-8 aware text sorting'],
  ]}
/>
...
<Aside type="tip">
  For action buttons (edit, delete), see the [Action Columns](../../reference/action-columns/)
  reference.
</Aside>

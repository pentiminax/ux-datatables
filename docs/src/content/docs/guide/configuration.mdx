...
Controls the positioning of DataTables UI features. Each position accepts a feature name, an array of features, `null` to hide, or a custom string (HTML, plugin name).

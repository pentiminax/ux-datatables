...
<Aside type="tip">
  All configuration options map directly to [DataTables options](https://datatables.net/reference/option/). Check the official documentation for advanced use cases.
</Aside>

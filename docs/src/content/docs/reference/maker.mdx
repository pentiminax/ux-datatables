...
<Table
  ...
  rows={[
    ...
    [
      ...
      'Maps `int/float` to `NumberColumn`, `bool` to `BooleanColumn`, and `DateTimeInterface` to `DateColumn`',
    ],
  ]}
/>
...
<Aside type="tip">
  The generated class is a starting point. Review the columns and adjust types, titles, sorting, and
  visibility based on your needs.
</Aside>

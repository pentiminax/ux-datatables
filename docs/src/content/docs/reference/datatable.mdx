...
<Table
  ...
  rows={[
    ...
    [
      "`ajaxRequestData(string $url, array $data, string $type = 'GET')`",
    ...
    [
      "`urlState(array $keys = [], string $prefix = '')`",
      'Sync selected DataTables state keys to the page URL query string',
    ],
...
<Table
  ...
  rows={[
    ...
    [
      ...
      'Configure column ordering behavior',
    ],
...
<Table
  ...
  rows={[
    ...
    [
      '`responsive(bool $auto = true, ?array $breakpoints = null, int|string $detailsTarget = 0, string|false $detailsType = \'inline\', string $orthogonal = \'display\')`',
    ...
    [
      '`select(SelectStyle $style = SelectStyle::SINGLE, ..., bool $withCheckbox = false, bool $headerCheckbox = false)`',
      'Add the Select extension, checkbox column included',
    ],
    ...
    [
      '`rowGroup(int|string|array $dataSrc, ...)`',
      'Add the RowGroup extension; the grouping data source is required',
    ],
  ]}
/>

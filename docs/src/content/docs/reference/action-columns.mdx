...
<Aside type="note">
  Action columns expect your dataset to contain an identifier that your frontend can use with the `actionUrl`.
</Aside>
...
<Aside type="tip">
  Action columns are excluded from exports (CSV, Excel, PDF) automatically. This ensures clean data exports without button markup.
</Aside>

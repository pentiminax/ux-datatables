...
<Aside type="note">
  ...
  detail action to resolve; it answers `400` otherwise, `404` when the entity no longer exists, and
  `403` when the permission check denies it. Like every bundle Ajax route, it must still be

...
<Aside type="note">
  Before you start, make sure [Symfony UX StimulusBundle](https://symfony.com/bundles/StimulusBundle/current/index.html) is configured in your application.
</Aside>
...
<Aside type="tip">
  You're all set! Continue to the [Quick Start](/getting-started/quick-start/) guide to create your first table.
</Aside>
